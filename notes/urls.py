...
from .views import home, register, user_login, user_logout, create_note_view, view_personal_notes, view_all_public_notes,\
    personal_note_detail_view, update_note, delete_note_view, public_note_detail_view
